...
/**
 * Formulario ABM para Nutricionistas.
 * Igual a UsuarioFormView pero Rol es siempre NUTRICIONISTA (read-only).
 */
public class NutricionistaFormView extends FormView<Usuario> {

    @Override
    protected void construirCampos(Usuario usuario, boolean esNuevo) {

        usuario.setRol(Rol.NUTRICIONISTA);
        ...
        tfRol.setValue(Rol.NUTRICIONISTA.name());
