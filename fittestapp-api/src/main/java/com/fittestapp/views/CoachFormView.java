...
/**
 * Formulario ABM para Coaches.
 * Igual a UsuarioFormView pero Rol es siempre COACH (read-only).
 */
public class CoachFormView extends FormView<Usuario> {

    @Override
    protected void construirCampos(Usuario usuario, boolean esNuevo) {

        usuario.setRol(Rol.COACH);
