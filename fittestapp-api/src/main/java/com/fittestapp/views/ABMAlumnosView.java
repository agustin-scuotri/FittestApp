...
@Route(value = "admin/alumnos", layout = AdminLayout.class)
@PageTitle("ABM Alumnos | FittestApp")
@RolesAllowed("ADMIN")
public class ABMAlumnosView extends AbmView<Usuario> {

    private static final DateTimeFormatter FECHA_FMT = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    private final UsuarioService usuarioService;

    public ABMAlumnosView(UsuarioService usuarioService) {
        this.usuarioService = usuarioService;
    }

    @Override
    protected String getTitulo() { return "Alumnos"; }
    ...
    protected List<Usuario> cargarItems() {
        return usuarioService.listarPorRol(Rol.ALUMNO);
    }
}
