...
@Route(value = "admin/admins", layout = AdminLayout.class)
@PageTitle("ABM Admins | FittestApp")
@RolesAllowed("ADMIN")
public class ABMAdminView extends AbmView<Usuario> {

    private static final DateTimeFormatter FECHA_FMT = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    private final UsuarioService usuarioService;

    public ABMAdminView(UsuarioService usuarioService) {
        this.usuarioService = usuarioService;
    }

    @Override
    protected String getTitulo() { return "Admins"; }
    ...
    protected List<Usuario> cargarItems() {
        return usuarioService.listarPorRol(Rol.ADMIN);
    }
}
