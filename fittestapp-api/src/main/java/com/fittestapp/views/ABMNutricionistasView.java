...
@Route(value = "admin/nutricionistas", layout = AdminLayout.class)
@PageTitle("ABM Nutricionistas | FittestApp")
@RolesAllowed("ADMIN")
public class ABMNutricionistasView extends AbmView<Usuario> {

    private static final DateTimeFormatter FECHA_FMT = DateTimeFormatter.ofPattern("dd/MM/yyyy");

    private final UsuarioService usuarioService;

    public ABMNutricionistasView(UsuarioService usuarioService) {
        this.usuarioService = usuarioService;
    }

    @Override
    protected String getTitulo() { return "Nutricionistas"; }
    ...
    protected FormView<Usuario> construirFormulario(Usuario u) {
        return new NutricionistaFormView();
    }

    @Override
    protected Usuario crearNuevoItem() {
        Usuario u = new Usuario();
        u.setRol(Rol.NUTRICIONISTA);
        return u;
    }
    ...
    @Override
    protected List<Usuario> cargarItems() { return usuarioService.listarPorRol(Rol.NUTRICIONISTA); }
}
