...
/**
 * Formulario ABM para Admins.
 * Igual a UsuarioFormView pero Rol es siempre ADMIN (read-only).
 */
public class AdminFormView extends FormView<Usuario> {
